...
echo "bx wsk action invoke ${OW_ACTION_NAME} -r -p wskAuth <WSK AUTH KEY> -p wskApiHost <WSK API HOST> -p repo <GH_REPO_URL> -p envData <JSON of env needed for wskdeploy, i.e. '{\"CLOUDANT_HOSTNAME\":\"MY_CLOUDANT_HOSTNAME\"}'>"
